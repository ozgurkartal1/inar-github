...
public class Question_06_39 {
    ...
    public static void main(String[] args) {
        ...
        if (!leftOfTheLine(x0, y0, x1, y1, x2, y2) && !onTheSameLineSegment(x0, y0, x1, y1, x2, y2)
        ...
        if (onTheSameLineSegment(x0, y0, x1, y1, x2, y2)) {

            System.out.println("(" + x2 + ", " + y2 + ") is on the same line segment " +
                    "from (" + x0 + ", " + y0 + ") to (" + x1 + ", " + y1 + ")");
        }
    ...
    public static boolean onTheSameLineSegment(double x0, double y0,
                                               double x1, double y1, double x2, double y2) {
